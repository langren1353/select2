...
S2.define('select2/pinyin',[
  ...
  function chnToPy(l1) {
    ...
    var l2 = l1.length;
    var I1 = new Array(2).fill('');
    if (l2 === 0) {
      return null;
    }
    var reg = new RegExp('[a-zA-Z0-9\- ]');
    for (var i = 0,len = l2; i < len; i++) {// 遍历每个选项中的汉字
  ...
  function ucfirst(l1) {
    if (l1.length > 0) {
      ...
      var firstFull = l1.toUpperCase();// 这里是不截取第一个字母，而是全匹配
      // var spare = l1.substr(1, l1.length);
      // 2015年6月11日 14:12:17
      var spare = '';
      return [first + spare, firstFull + spare];
    }
  }
